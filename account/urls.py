...
urlpatterns = [
    ...
    path('add_data_psy/', views.add_data_psy, name='add_data_psy'),
    path('add_data_ped/', views.add_data_ped, name='add_data_ped'),
    path('view_data/', views.view_data, name='view_data'),
    path('view_data_psy/', views.view_data_psy, name='view_data_psy'),
    path('view_data_ped/', views.view_data_ped, name='view_data_ped'),
    path('loginpediatrician/', views.loginpediatrician, name='loginpediatrician'),
  ...
  #SHAHD
    ...
    path('thank_you_pys/', views.thank_you_pys, name='thank_you_pys'),
    path('thank_you_ped/', views.thank_you_ped, name='thank_you_ped'),
    path('pys_comment/', views.pys_comment, name='pys_comment'),
